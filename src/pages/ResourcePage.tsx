...
import { ChevronRight, GraduationCap, Award, BookAudio } from "lucide-react";
...
// Section for Resources, Courses, Certifications, Podcasts
      ...
      <CollapsibleContent>
        <div className="grid gap-6">
          {resources.map((resource, index) => (
            ...
            >
              <Card
                className="transition-all duration-300 hover:shadow-lg bg-white border-2 border-black
...
const ResourcePage = () => {
  ...
  return (
    <Layout categories={categories} activeCategory={activeCategory} onCategoryChange={handleCategoryChange}>
      <div className="p-8">
        ...
        <header className="border-b-4 border-black mb-12 pb-4">
          ...
          <p className="text-xl text-black/70 italic">Essential resources and materials</p>
        </header>
        ...
        <ResourceSection title="Podcasts" resources={categoryData.podcasts} icon={BookAudio} />
      </div>
    </Layout>
  );
};
